...
void DrawManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DrawManager *_t = static_cast<DrawManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DrawManager::*_t)(int , int , int , int , int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DrawManager::positions)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DrawManager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawManager.data,
      qt_meta_data_DrawManager,  qt_static_metacall, nullptr, nullptr}
};
